...
**SEIAR**: This predictive model was pulled from the Army's ACME Tool developed through collaborative efforts from Army Futures Command and the Army Public Health Center(APHC) COVID-19 Modeling Team. This model was inspired by Penn State's CHIME model.  
